...
var author$project$Main$NewApple = function (a) {
	return {$: 'NewApple', a: a};
};
...
var author$project$Main$init = _Utils_Tuple2(
	{
		apple: _Utils_Tuple2(-10, -10),
		others: _List_Nil
	},
	A2(
		elm$random$Random$generate,
		author$project$Main$NewApple,
		A2(
...
var author$project$Main$activeUsers = _Platform_incomingPort(
	'activeUsers',
								...
								return A2(
									...
									function (colour) {
										return elm$json$Json$Decode$succeed(
											{colour: colour, name: name, x: x, y: y});
									},
...
var author$project$Main$buildPlayer = function (basicPlayer) {
	var x = basicPlayer.x;
	var y = basicPlayer.y;
	var colour = basicPlayer.colour;
	var name = basicPlayer.name;
	return {
		colour: colour,
		name: name,
		pos: {x: x, y: y},
		style: mdgriffith$elm_style_animation$Animation$style(
			_List_fromArray(
				[
					...
					mdgriffith$elm_style_animation$Animation$px(x * author$project$Main$sideLength)),
					mdgriffith$elm_style_animation$Animation$top(
					mdgriffith$elm_style_animation$Animation$px(y * author$project$Main$sideLength))
				]))
	};
};
...
var author$project$Main$mergePlayers = F2(
	function (newList, oldList) {
		...
		var mapNew = function (n) {
			var _n0 = oldOne(n);
			if (_n0.$ === 'Nothing') {
				return author$project$Main$buildPlayer(n);
			} else {
				var o = _n0.a;
				return A3(author$project$Main$updatePlayer, o, n.x, n.y);
			}
		};
...
var author$project$Main$wsSend = _Platform_outgoingPort(
	'wsSend',
	function ($) {
		var a = $.a;
		var b = $.b;
			...
			case 'NewApple':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							apple: _Utils_Tuple2(x, y)
						}),
					elm$core$Platform$Cmd$none);
			case 'UserUpdate':
				var players = action.a;
				var others = A2(author$project$Main$mergePlayers, players, model.others);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{others: others}),
...
var author$project$Main$drawApple = function (_n0) {
	var x = _n0.a;
	var y = _n0.b;
	var ypx = elm$core$String$fromInt(y * author$project$Main$sideLength);
	var xpx = elm$core$String$fromInt(x * author$project$Main$sideLength);
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'position', 'absolute'),
				A2(elm$html$Html$Attributes$style, 'left', xpx + 'px'),
				A2(elm$html$Html$Attributes$style, 'top', ypx + 'px'),
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					A2(elm$html$Html$Attributes$style, 'background-image', 'url(mario.gif)'),
					A2(elm$html$Html$Attributes$style, 'background-size', '50px 50px')
				]),
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_Utils_ap(
			_List_Nil,
			_Utils_ap(
				A2(elm$core$List$map, author$project$Main$square, model.others),
				_List_fromArray(
					[
						author$project$Main$drawApple(model.apple)
					]))));
};
